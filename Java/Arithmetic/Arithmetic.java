...
public class Arithmetic {
    ...
    public static float div(Float f1,Float f2){
        BigDecimal b1 = new BigDecimal(f1.toString());
        BigDecimal b2 = new BigDecimal(f2.toString());
        return b1.divide(b2,DEFAULT_NUMBER_OF_FLOAT_DIGITS,BigDecimal.ROUND_HALF_UP).floatValue();
    }
    ...
    public static Double div(Double d1,Double d2){
        BigDecimal b1 = new BigDecimal(d1.toString());
        BigDecimal b2 = new BigDecimal(d2.toString());
        return b1.divide(b2,DEFAULT_NUMBER_OF_DOUBLE_DIGITS,BigDecimal.ROUND_HALF_UP).doubleValue();
    }
